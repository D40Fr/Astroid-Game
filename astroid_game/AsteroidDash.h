...
public:
    ...
    void celestial_object_update();
    void grid_clear_or_set(const CelestialObject* curr, int number);
    bool check_collision(CelestialObject* celestial_object, Player* player);
    void player_update();
